...
class Endpoint::Core : public std::enable_shared_from_this<Core> {
 ...
 private:
  ...
  void BeginInvoke(OpcUa_GetEndpointsRequest& request, const std::function<void(GetEndpointsResponse& response)>& callback);
  void BeginInvoke(OpcUa_FindServersRequest& request, const std::function<void(FindServersResponse& response)>& callback);
  void BeginInvoke(OpcUa_CreateSessionRequest& request, const std::function<void(CreateSessionResponse& response)>& callback);

// WARNING: Supresses errors.
  template<class Response>
  void SendResponse(OpcUa_Handle& context, const OpcUa_RequestHeader& request_header, Response&& response);

  // WARNING: Suppresses errors.
  void SendFault(OpcUa_Handle& context, const OpcUa_RequestHeader& request_header, ResponseHeader&& response_header);
  ...
  struct Registry {
    std::mutex mutex;
    std::map<OpcUa_Handle /*endpoint*/, std::shared_ptr<Core>> endpoints;
  };

  static Registry& registry();

  static void AddEndpoint(OpcUa_Handle endpoint_handle, std::shared_ptr<Core> endpoint);
  static void RemoveEndpoint(OpcUa_Handle endpoint_handle);
  static std::shared_ptr<Core> GetEndpoint(OpcUa_Handle endpoint_handle);
...
inline Endpoint::Core::Core(OpcUa_Endpoint_SerializerType serializer_type) {
  Check(::OpcUa_Endpoint_Create(&handle_, serializer_type, const_cast<OpcUa_ServiceType**>(MakeSupportedServices().data())));
}

inline Endpoint::Core::~Core() {
}

inline void Endpoint::Core::Close() {
...
inline void Endpoint::Open(String                                  url,
                    bool                                    listen_on_all_interfaces,
                    const OpcUa_ByteString&                 server_certificate,
                    const OpcUa_Key&                        server_private_key,
                    const OpcUa_Void*                       pki_config,
...
inline void Endpoint::Core::Open(String                                  url,
                    bool                                    listen_on_all_interfaces,
                    const OpcUa_ByteString&                 server_certificate,
                    const OpcUa_Key&                        server_private_key,
                    const OpcUa_Void*                       pki_config,
...
inline std::vector<const OpcUa_ServiceType*> Endpoint::Core::MakeSupportedServices() const {
  static const OpcUa_ServiceType kServiceTypes[] = {
      {
        OpcUaId_GetEndpointsRequest,
        &OpcUa_GetEndpointsResponse_EncodeableType,
        static_cast<OpcUa_PfnBeginInvokeService*>(&BeginInvokeEndpoint<OpcUa_GetEndpointsRequest, GetEndpointsResponse>),
      },
      {
        OpcUaId_FindServersRequest,
        &OpcUa_FindServersResponse_EncodeableType,
        static_cast<OpcUa_PfnBeginInvokeService*>(&BeginInvokeEndpoint<OpcUa_FindServersRequest, FindServersResponse>),
      },
      {
        OpcUaId_CreateSessionRequest,
        &OpcUa_CreateSessionResponse_EncodeableType,
        static_cast<OpcUa_PfnBeginInvokeService*>(&BeginInvokeEndpoint<OpcUa_CreateSessionRequest, CreateSessionResponse>),
      },
      {
        OpcUaId_ActivateSessionRequest,
        &OpcUa_ActivateSessionResponse_EncodeableType,
        static_cast<OpcUa_PfnBeginInvokeService*>(&BeginInvokeSession<OpcUa_ActivateSessionRequest, ActivateSessionResponse>),
      },
      {
        OpcUaId_CloseSessionRequest,
        &OpcUa_CloseSessionResponse_EncodeableType,
        static_cast<OpcUa_PfnBeginInvokeService*>(&BeginInvokeSession<OpcUa_CloseSessionRequest, CloseSessionResponse>),
      },
      {
        OpcUaId_ReadRequest,
        &OpcUa_ReadResponse_EncodeableType,
        static_cast<OpcUa_PfnBeginInvokeService*>(&BeginInvokeSession<OpcUa_ReadRequest, ReadResponse>),
      },
      {
        OpcUaId_BrowseRequest,
        &OpcUa_BrowseResponse_EncodeableType,
        static_cast<OpcUa_PfnBeginInvokeService*>(&BeginInvokeSession<OpcUa_BrowseRequest, BrowseResponse>),
      },
      {
        OpcUaId_CreateSubscriptionRequest,
        &OpcUa_CreateSubscriptionResponse_EncodeableType,
        static_cast<OpcUa_PfnBeginInvokeService*>(&BeginInvokeSession<OpcUa_CreateSubscriptionRequest, CreateSubscriptionResponse>),
      },
      {
        OpcUaId_CreateMonitoredItemsRequest,
        &OpcUa_CreateMonitoredItemsResponse_EncodeableType,
        static_cast<OpcUa_PfnBeginInvokeService*>(&BeginInvokeSubscription<OpcUa_CreateMonitoredItemsRequest, CreateMonitoredItemsResponse>),
      },
      {
        OpcUaId_DeleteMonitoredItemsRequest,
        &OpcUa_DeleteMonitoredItemsResponse_EncodeableType,
        static_cast<OpcUa_PfnBeginInvokeService*>(&BeginInvokeSubscription<OpcUa_DeleteMonitoredItemsRequest, DeleteMonitoredItemsResponse>),
      },
      {
        OpcUaId_PublishRequest,
        &OpcUa_PublishResponse_EncodeableType,
        static_cast<OpcUa_PfnBeginInvokeService*>(&BeginInvokeSession<OpcUa_PublishRequest, PublishResponse>),
      },
  };
...
template<class Request, class Response>
inline OpcUa_StatusCode Endpoint::Core::BeginInvokeEndpoint(
    OpcUa_Endpoint        a_hEndpoint,
    OpcUa_Handle          a_hContext,
    OpcUa_Void**          a_ppRequest,
    OpcUa_EncodeableType* a_pRequestType) {
  ...
  if (!endpoint) {
    ...
    endpoint->SendFault(a_hContext, request.RequestHeader, std::move(response_header));
    return OpcUa_Good;
  }

  endpoint->BeginInvoke(request, [endpoint, a_hContext, request_header = request.RequestHeader](Response& response) mutable {
    if (OpcUa_IsGood(response.ResponseHeader.ServiceResult))
      endpoint->SendResponse(a_hContext, request_header, std::move(response));
    else
      endpoint->SendFault(a_hContext, request_header, std::move(response.ResponseHeader));
  });
...
template<class Request, class Response>
inline OpcUa_StatusCode Endpoint::Core::BeginInvokeSession(
    OpcUa_Endpoint        a_hEndpoint,
    OpcUa_Handle          a_hContext,
    OpcUa_Void**          a_ppRequest,
    OpcUa_EncodeableType* a_pRequestType) {
  ...
  session->BeginInvoke(request, [endpoint, a_hContext, request_header = request.RequestHeader](Response& response) mutable {
    if (OpcUa_IsGood(response.ResponseHeader.ServiceResult))
      endpoint->SendResponse(a_hContext, request_header, std::move(response));
    else
      endpoint->SendFault(a_hContext, request_header, std::move(response.ResponseHeader));
...
template<class Request, class Response>
inline OpcUa_StatusCode Endpoint::Core::BeginInvokeSubscription(
    OpcUa_Endpoint        a_hEndpoint,
    OpcUa_Handle          a_hContext,
    OpcUa_Void**          a_ppRequest,
    OpcUa_EncodeableType* a_pRequestType) {
  ...
  subscription->BeginInvoke(request, [endpoint, a_hContext, request_header = request.RequestHeader](Response& response) mutable {
    if (OpcUa_IsGood(response.ResponseHeader.ServiceResult))
      endpoint->SendResponse(a_hContext, request_header, std::move(response));
    else
      endpoint->SendFault(a_hContext, request_header, std::move(response.ResponseHeader));
...
inline void PrepareResponse(const OpcUa_RequestHeader& request_header, OpcUa_StatusCode status_code, OpcUa_ResponseHeader& response_header) {
...
// static
inline void Endpoint::Core::BeginInvoke(OpcUa_GetEndpointsRequest& request, const std::function<void(GetEndpointsResponse& response)>& callback) {
...
// static
inline Vector<OpcUa_EndpointDescription> Endpoint::Core::GetEndpoints() {
...
// static
inline void Endpoint::Core::BeginInvoke(OpcUa_FindServersRequest& request, const std::function<void(FindServersResponse& response)>& callback) {
...
// static
inline Vector<OpcUa_ApplicationDescription> Endpoint::Core::FindServers() {
  std::lock_guard<std::mutex> lock{registry().mutex};
...
inline NodeId Endpoint::Core::MakeAuthenticationToken() {
  // TODO: Namespace index.
  return NodeId{"FixMe", 101};
}

inline NodeId Endpoint::Core::MakeSessionId() {
  // TODO: Namespace index.
  return NodeId{next_session_id_++, 100};
}

// static
inline void Endpoint::Core::BeginInvoke(OpcUa_CreateSessionRequest& request, const std::function<void(CreateSessionResponse& response)>& callback) {
...
template<class Response>
inline void Endpoint::Core::SendResponse(OpcUa_Handle& context, const OpcUa_RequestHeader& request_header, Response&& response) {
  PrepareResponse(request_header, response.ResponseHeader.ServiceResult, response.ResponseHeader);
  ::OpcUa_Endpoint_EndSendResponse(handle_, &context, OpcUa_Good, &response, const_cast<OpcUa_EncodeableType*>(&Response::type()));
}

inline void Endpoint::Core::SendFault(OpcUa_Handle& context, const OpcUa_RequestHeader& request_header, ResponseHeader&& response_header) {
  ...
  if (OpcUa_IsBad(::OpcUa_ServerApi_CreateFault(const_cast<OpcUa_RequestHeader*>(&request_header),
        ...
        &response_header.StringTable, &response, &response_type))) {
    return;
  }

  ::OpcUa_Endpoint_EndSendResponse(handle_, &context, OpcUa_Good, response, response_type);
  ::OpcUa_EncodeableObject_Delete(response_type, &response);
}


inline ApplicationDescription Endpoint::Core::GetApplicationDescription() const {
...
inline EndpointDescription Endpoint::Core::GetEndpointDescription() const {
...
inline std::shared_ptr<Session> Endpoint::Core::CreateSession(String session_name) {
...
inline std::shared_ptr<Session> Endpoint::Core::GetSession(const NodeId& authentication_token) {
  std::lock_guard<std::mutex> lock{mutex_};
...
inline void Endpoint::set_create_monitored_item_handler(CreateMonitoredItemHandler handler) {
  core_->set_create_monitored_item_handler(std::move(handler));
}

// static
inline Endpoint::Core::Registry& Endpoint::Core::registry() {
  static Registry registry;
  return registry;
}

// static
inline void Endpoint::Core::AddEndpoint(OpcUa_Handle endpoint_handle, std::shared_ptr<Core> endpoint) {
  std::lock_guard<std::mutex> lock{registry().mutex};
  registry().endpoints.emplace(endpoint_handle, std::move(endpoint));
}

// static
inline void Endpoint::Core::RemoveEndpoint(OpcUa_Handle endpoint_handle) {
  std::lock_guard<std::mutex> lock{registry().mutex};
  registry().endpoints.erase(endpoint_handle);
}

// static
inline std::shared_ptr<Endpoint::Core> Endpoint::Core::GetEndpoint(OpcUa_Handle endpoint_handle) {
  std::lock_guard<std::mutex> lock{registry().mutex};
