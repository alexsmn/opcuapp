...
class ExtensionObject {
 public:
  ExtensionObject() { ::OpcUa_ExtensionObject_Initialize(&value_); }

  ExtensionObject(ExtensionObject&& source) : value_{source.value_} {
    ::OpcUa_ExtensionObject_Initialize(&source.value_);
  }

  ExtensionObject(OpcUa_ExtensionObject&& source) : value_{source} {
  ...
  ExtensionObject(const OpcUa_EncodeableType& type, OpcUa_Void* object) {
    ...
    value_.Body.EncodeableObject.Type =
        const_cast<OpcUa_EncodeableType*>(&type);
...
inline void Copy(const OpcUa_ExtensionObject& source,
                 OpcUa_ExtensionObject& target) {
  switch (source.Encoding) {
    ...
    case OpcUa_ExtensionObjectEncoding_EncodeableObject: {
      ...
      ::OpcUa_EncodeableObject_CreateExtension(
          source.Body.EncodeableObject.Type, &target, &object);
      CopyEncodeable(*source.Body.EncodeableObject.Type,
                     source.Body.EncodeableObject.Object, object);
