...
constexpr NumericId Float = 10;
constexpr NumericId Double = 11;
constexpr NumericId ByteString = 15;
constexpr NumericId String = 12;
constexpr NumericId Guid = 14;
constexpr NumericId XmlElement = 16;
constexpr NumericId StatusCode = 19;
constexpr NumericId QualifiedName = 20;
constexpr NumericId LocalizedText = 21;
constexpr NumericId Structure = 22;
constexpr NumericId DataValue = 23;
constexpr NumericId DiagnosticInfo = 25;
